 ...
 *  are typically fine. For example below is a user-specific template counter:
 *
 *       connect()
 *         .use(connect.favicon())
 *         .use(connect.cookieParser())
 ...
 *    - `.clear(callback)`
 *
 * For an example implementation template the [connect-redis](http://github.com/visionmedia/connect-redis) repo.
 *
